...
<title>FAQ's for international Students - LPU</title>
<meta name="description" content="If you have any question regarding Lovely Professional University please check our FAQ page." />
...
<li><a href="../../cdn-cgi/l/email-protection#442520292d37372d2b2a37042834316a272b6a2d2a" class="si-email3"><span class="ts-icon"><i class="icon-email3"></i></span></a></li>
...
<div id="top-search">
<a href="int_faq.php#" id="top-search-trigger"><i class="icon-search3"></i><i class="icon-line-cross"></i></a>
...
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Where should I book my ticket to?</div>
<div class="acc_content clearfix">Air tickets should be booked to Amritsar Airport in Punjab.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Which is the nearest airport where there are direct flights from UK?</div>
<div class="acc_content clearfix">Nearest Airport would be Indira Gandhi International Airport, New Delhi</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Are there many connecting flights from New Delhi airport to Amritsar airport?
</div>
<div class="acc_content clearfix">Yes, there are many connecting flights from Delhi to Amritsar airport.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i> If there are other routes from where I can book my flight directly to Amritsar?
</div>
<div class="acc_content clearfix">Yes, Amritsar is also an international airport and there are few flights from Dubai as well to Amritsar. </div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>If there are any Pick up facility from Amritsar airport?
</div>
<div class="acc_content clearfix">Yes, there is complimentary pickup facility from Amritsar Airport for all the participants who are coming under Incredible India Program.
</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Would I need to get the medical insurance even before joining the university?
</div>
<div class="acc_content clearfix">Yes, it is strongly advisable to get your medical insurance for the complete duration of the program.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What currency is acceptable in India and if I have to get it exchanged in what currency should I bring money. Is there any money exchange inside the university?
</div>
<div class="acc_content clearfix">In India the currency being used is Indian National Rupee (INR). You can bring the Sterling Pounds or USD which can be exchanged either at Airport or in the University Campus.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Does the university campus have ATM and if the International Debit/Credit cards are accepted in India and campus?
</div>
<div class="acc_content clearfix">Yes, there are close to 50 ATMS within in the university campus and almost all of them accept the VISA, MasterCard and Maestro powered cards. Though there are regulation to withdraw amount up to certain limit only on daily basis. We also have Western Union Branch at our campus for exchange. Pre-paid credit cards also acceptable at the ATM’s but for that you should have International Withdrawal approved from your bank.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What are the documents that I should carry when I land that is required to be handy for the immigration purpose at the Airport?
</div>
<div class="acc_content clearfix"><ul><li>Passport</li><li>Invitation Letter by the university</li></ul></div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>Can I Purchase such items like Snacks, Souvenir, Books, and Stationary etc. from the university campus?
</div>
<div class="acc_content clearfix">University has a full-fledged shopping mall in the university campus itself and you can purchase most of the products on the campus itself.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What medical facilities are available on campus?
</div>
<div class="acc_content clearfix">We have on campus Hospital which works 24*7.
</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What if I arrive in India or travel to India before program?</div>
<div class="acc_content clearfix">If you arrive prior to the scheduled date then you will have to reach the university campus on your own and you can stay in university hotel at additional cost.</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What is the temperature or weather condition in the city where LPU is located?
</div>
<div class="acc_content clearfix">Summer in northwestern India starts from April and ends in July, and in the rest of the country from March to June. By July, most of the Indian interior experiences mean temperatures over 35°C(95°F), while maximum temperatures often exceed 40°C(104 °F).</div>
<div class="acctitle"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>What kind of clothes should I carry with me?
</div>
<div class="acc_content clearfix">Little formal and comfortable cotton cloths would be best option. Please do keep in mind the Indian Tradition while packing cloths. It is not a formal academic environment but also not casual fun environment.</div>
</div>
</div>
</div>
...
<li>
<a target="_blank" href="int_faq.php#" data-gtm-section="sticky" data-toggle="modal" data-target="#conference-modal">
...
<li class>
<a data-toggle="modal" class="feedback-btn" data-target="#feedback-modal" href="int_faq.php#" target="_blank" data-gtm-section="sticky">
...
<li> <a data-toggle="modal" data-target="#convocation" href="int_faq.php#">10th Convocation
Gallery</a> </li>
...
<form id="widget-subscribe-form" action="int_faq.php#" role="form" method="post" class="nobottommargin">
...
<br>
<span style="font-size:12px;"> Problem with this page ? <a style="font-size:12px;" href="../../cdn-cgi/l/email-protection#8bfceee9e6eaf8ffeef9cbe7fbfea5e8e4a5e2e5b4f8fee9e1eee8ffb6c6eae2e7abedf9e4e6abe7fbfea5e2e5abdceee9f8e2ffee">Contact
Webmaster</a></span>
</div>
</div>
</div>
...
<div class="text-center pa20" id="feebackSubmitbtn"><a href="int_faq.php#" class="button button-small button-dark button-rounded" onclick="submitFeeback();">Submit</a>
</div>
<div class="text-center pa20" id="feebackSubmitbtn1" style="display:none;"><a href="int_faq.php#" class="button button-small button-dark button-rounded" onclick="gotoNextNew();">Next</a>
</div>
</div>
</div>
</div>
...
<li> "Sexual Harassment Complaint Registration: - <a href="../../cdn-cgi/l/email-protection#90f9f3f3d0fce0e5bef3ffbef9fe" target="_top"><span class="__cf_email__" data-cfemail="a7cec4c4e7cbd7d289c4c889cec9">[email&#160;protected]</span></a> </li>
...
<li><a href="int_faq.php#tabs-33">2020</a></li>
</ul>
...
<li class="nirf-hd">Email ID for Comments & Feedback : <span><a href="../../cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4c3e292b253f383e2d3e0c203c39622f23622522">[email&#160;protected]</a></span>
</li>
</ul>
</div>
</div>
...
<div class="tabs tabs-bb clearfix" id="tab-9">
<ul class="tab-nav clearfix">
<li><a href="int_faq.php#tabs-37">2022</a></li>
<li><a href="int_faq.php#tabs-38">2023</a></li>
</ul>
<div class="tab-container">
...
<div class="modal-footer">
<ul class="iconlist text-center nirf" style="margin:0 !important;">
<li class="nirf-hd">Email ID for Comments & Feedback : <span><a href="../../cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="542631333d2720263526143824217a373b7a3d3a">[email&#160;protected]</a></span>
</li>
</ul>
</div>
</div>
